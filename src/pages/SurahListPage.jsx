...
// } from "../data/surahApi";
// import AddSurahModal from "../Admin/AddSurahModal";
// import { deleteSurah } from "../data/ayatsData";
// import { updateSurah } from "../data/ayatsData";
...
//       return (
//         surah.surah_name_arabic?.includes(searchQuery) ||
//         surah.surah_name_malayalam?.includes(searchQuery) ||
//         surah.surah_name_english?.toLowerCase().includes(q) ||
...
//   const handleLongPressStart = (e, surah) => {
//     e.preventDefault();
//     longPressTimer = setTimeout(() => setLongPressedSurah(surah), 600);
//   };
//   const handleLongPressEnd = () => clearTimeout(longPressTimer);

//   const handleDeleteSurah = async (id) => {
//     if (!window.confirm("Delete this Surah?")) return;
//     try {
//       await deleteSurah(id);
//       setSurahs((prev) => prev.filter((s) => s.id !== id));
//       setLongPressedSurah(null);
...
//             value={searchQuery}
//             onChange={(e) => setSearchQuery(e.target.value)}
//             className="w-full h-10 pl-12 pr-4 rounded-2xl border-2 border-teal-200 focus:border-teal-400 bg-white/90 shadow-lg"
//           />
//         </div>
...
//               onTouchStart={(e) => handleLongPressStart(e, s)}
//               onTouchEnd={handleLongPressEnd}
//               onMouseDown={(e) => handleLongPressStart(e, s)}
//               onMouseUp={handleLongPressEnd}
//               className="group relative h-16 rounded-3xl p-6 shadow-md hover:shadow-xl border border-teal-100 hover:border-teal-300 bg-white/60 backdrop-blur cursor-pointer transition"
//             >
//               {/* Normal content */}
...
//                 <div className="absolute inset-0 flex justify-center items-center gap-6 bg-white/95 rounded-3xl">
//                   <button
//                     onClick={(e) => {
//                       e.stopPropagation();
//                       setEditingSurah(s);
...
//         <div className="absolute inset-0 flex justify-center items-center z-50 bg-black/40 backdrop-blur-sm">
//           <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-md">
//             <AddSurahModal onClose={() => setShowAdd(false)} onSave={() => setShowAdd(false)} />
//           </div>
//         </div>
//       )}
